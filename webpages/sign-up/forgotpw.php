    ...
    <div class="container text-center bg-dark text-white">
        <div class="row">
            <div class="col px-auto mx-auto">
                <img src="../../CSS/images/LOGO-RED.png" class="img-responsive img-fluid" alt="Responsive image">
            </div>
            <div class="col py-5 my-5">
                ...
                <form actions="#" method="POST">
                    ...
                    ?>
                    <div class="">Forgot password? <br>Enter your email address you have registered <br> with and we will send a reset password form via email</div>
                    <br><br>
                    <div>
                        <label>email</label>
                    ...
                    <div class="text-white">
                        <button type="submit" class="btn text-white" name="send-email-request-form">Send Email Request Form</button>
                    </div>
                    <br>
                </form>
            </div>
